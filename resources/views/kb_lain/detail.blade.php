    ...
    @else
        ...
        <div class="box p-5 mx-auto my-auto bg-white bg-opacity-50">
            ...
            <div class="card-footer text-center">
                <a href="{{route('kb_l.kbl_home')}}" class="btn btn-sm btn-secondary" style="width: 90px">
                ...
                <div class="modal fade" id="sah" data-backdrop="static">
                    <div class="modal-dialog">
                        <div class="modal-content bg-warning">
                            ...
                            <form action="{{route('kb_l.sah',['id'=>$loaner->id])}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="modal-body">
                                    ...
                                    <div class="form-group text-blue">
                                        ...
                                        <textarea rows="2" name="review" class="form-control"
                                                  id="review"
                ...
                <div class="modal fade" id="tolak" data-backdrop="static">
                    <div class="modal-dialog">
                        <div class="modal-content bg-warning">
                            ...
                            <form action="{{route('kb_l.tolak',['id'=>$loaner->id])}}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="modal-body">
