        ...
        <div class="card-header font-bold text-xl">
            ...
            <div class="card-body">
                ...
                <form id="registration-form" method="POST" action="{{route('borrower.borrow')}}">
                    @csrf
                    <div class="form-step step-1 mt-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                <label for="location">Lokasi Peralatan Digunakan</label>
                                <input type="text" id="location" name="location"
                                       class="form-control mb-3 mt-1" value="{{old('location')}}"
                                       autofocus autocomplete="location" required>
                    ...
                    <div class="form-step step-2 d-none">
                        <h5 class="text-center font-weight-bold mt-5">PERALATAN</h5>
                        <p class="text-danger text-bold text-center mb-5 mt-3" style="font-size: 14px">
                            Sila tandakan pada kotak terlebih dahulu bagi memilih peralatan
                        </p>
                        <div class="row">
                            <div class="form-group col-md-4">
